 ...
 */
+ (LISNRDataTone * _Nullable) toneWithData:(NSData * _Nonnull)data iterations:(int)iterations sampleRate:(LISNRToneSampleRate)sampleRate error:(NSError * _Nullable *)error;
