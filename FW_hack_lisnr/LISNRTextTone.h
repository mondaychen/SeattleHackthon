 ...
 */
@property (strong, nonatomic, readonly) NSString * _Nonnull text;
 ...
 */
+ (LISNRTextTone * _Nullable) toneWithText:(NSString * _Nonnull)text iterations:(int)iterations sampleRate:(LISNRToneSampleRate)sampleRate error:(NSError * _Nullable *)error;
